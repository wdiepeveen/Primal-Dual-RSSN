...
function process_RSSN_comparison_algorithms_S2(λ;postfix="",view_result::Bool=false,path::Union{String,Missing}=missing)
   ...
   if view_result
      ...
      renderAsymptote(exp_prefix()*"result-lRCPA-S2"*postfix*".asy", asyExportS2Data; data=fR_lrcpa, render=4)
      renderAsymptote(exp_prefix()*"result-RSSN-S2"*postfix*".asy", asyExportS2Data; data=fR_lrssn, render=4)
   else
      asyExportS2Data(exp_prefix()*"original-S2.asy";data=data)
      asyExportS2Data(exp_prefix()*"result-lRCPA-S2"*postfix*".asy";data=fR_lrcpa)
      asyExportS2Data(exp_prefix()*"result-RSSN-S2"*postfix*".asy";data=fR_lrssn)
   end
