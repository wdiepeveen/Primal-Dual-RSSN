...
function run_RSSN_comparison_algorithms_SPD3(λ;postfix="",return_result::Bool=false)
   ...
   for (i,tol) in enumerate(tols)
      ...
      fR_lrcpa,r_lrcpa = lRCPA(lrcpaP,start,y0=dualstart,tol=tol/relerror,max_it=50*max_it)
      lrcpat = CPUtoc()
