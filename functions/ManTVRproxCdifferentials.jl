...
function ManTVRproxDualCdifferential(N::TangentBundle,n::TBPoint,
    Η::TBTVector,Ξ::TBTVector,λτ::Float64,anisotropic=true)
...
function ManTVRproxDualCdifferential(M::Manifold,m::MPoint,d::Tuple,
    jk::Tuple{CartesianIndex,Int},η::TVector,ξ::TVector,λτ::Float64,
    anisotropic=true)
